...
\setlength{\oddsidemargin}{15mm}  % This gives a binding margin of 40mm
...
\include{Chapters/eagle-alpha-resubmit}
\include{thesis/Chapters/high_eccentricity_pop}
...
\appendix
\include{Appendices/appendices1}
\include{Appendices/appendices2}
\include{Appendices/appendices3}
%ADD APPENDICES HERE
